...
const NutrientEffectsVisualizer = () => {
    ...
    const renderBeaker = (s: string) => (
        <g transform="translate(0, 50)">
            ...
            {/* Culture fill */}
            <g clipPath={`url(#beaker-clip-nutrient${s})`}>
                <path
                ...
                <g clipPath={`url(#wave-clip-nutrient${s})`}>
    ...
    const renderMagnified = (s: string) => (
        <g>
            ...
            <clipPath id={`magnifier-clip-nutrient${s}`}>
                <circle cx={MX} cy={MY} r={MR - 2} />
            </clipPath>
            <g clipPath={`url(#magnifier-clip-nutrient${s})`}>
        ...
        <div className="flex flex-col py-4 select-none">
            ...
            <div className="sm:hidden mb-3">
                <div className="flex items-center justify-between mb-1">
                    <span className="text-xs font-medium text-foreground">Nutrient Conc. S (mM)</span>
                    <span className="text-sm font-mono font-bold" style={{ color: 'rgb(140, 80, 200)' }}>{S.toFixed(1)} mM</span>
                </div>
                <Slider
                    min={0}
                    max={20}
                ...
                <div className="flex justify-between mt-0.5">
                    <span className="text-[10px] font-mono text-muted-foreground">0 Dilute</span>
                    <span className="text-[10px] font-mono text-muted-foreground">10 Optimal</span>
                    <span className="text-[10px] font-mono text-muted-foreground">20 Saturated</span>
                </div>
            </div>
