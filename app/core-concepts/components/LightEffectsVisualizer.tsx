...
const LightEffectsVisualizer = () => {
    ...
    const renderBeaker = (s: string) => (
        <g transform="translate(0, 50)">
            <defs>
                <clipPath id={`beaker-clip-light${s}`}>
                ...
                <linearGradient id={`light-strip-grad${s}`} x1="0" y1="0" x2="0" y2="1">
                ...
                <linearGradient id={`light-culture-grad${s}`} x1="0" y1="0" x2="1" y2="0">
                ...
                <radialGradient id={`light-glow${s}`} cx="0" cy="0.5" r="1" fx="0" fy="0.5">
            ...
            <rect x="30" y="44" width="18" height="171" fill={`url(#light-strip-grad${s})`} />
            ...
            <g clipPath={`url(#beaker-clip-light${s})`}>
                <path
                ...
                <rect x="40" y="40" width="120" height="180" fill={`url(#light-culture-grad${s})`} />
            </g>
        ...
        <div className="flex flex-col py-4 select-none">
            ...
            <div className="sm:hidden mb-3">
                <div className="flex items-center justify-between mb-1">
                    <span className="text-xs font-medium text-foreground">Intensity I (µE/m²/s)</span>
                    <span className="text-sm font-mono font-bold" style={{ color: 'rgb(210, 150, 20)' }}>{intensity} μE/m²/s</span>
                </div>
                <Slider
                    min={0}
                    max={1000}
                ...
                <div className="flex justify-between mt-0.5">
                    <span className="text-[10px] font-mono text-muted-foreground">0 Low</span>
                    <span className="text-[10px] font-mono text-muted-foreground">300 Optimal</span>
                    <span className="text-[10px] font-mono text-muted-foreground">1000 High</span>
                </div>
            </div>

            {/* Mobile scene */}
            <svg viewBox="0 75 380 240" className="w-full sm:hidden mb-2">
                {renderBeaker('-m')}
            ...
            {/* Mobile charts */}
            <svg viewBox="420 40 625 275" className="w-full sm:hidden">
                {renderCharts()}
            </svg>

            {/* Desktop layout (unchanged) */}
            <div className="hidden sm:flex sm:flex-row sm:items-end sm:gap-12">
                {/* Vertical Slider */}
