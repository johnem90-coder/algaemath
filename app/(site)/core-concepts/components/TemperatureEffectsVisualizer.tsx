...
const TemperatureEffectsVisualizer = () => {
    ...
    const renderBeaker = (s: string) => (
        <g transform="translate(0, 50)">
            <defs>
                ...
                <linearGradient id={`temp-culture-grad${s}`} x1="0" y1="1" x2="0" y2="0">
            ...
            {/* Culture fill */}
            <g clipPath={`url(#beaker-clip-temp${s})`}>
                <path
                ...
                <g clipPath={`url(#wave-clip-temp${s})`}>
                    <rect x="40" y="40" width="120" height="180" fill={`url(#temp-culture-grad${s})`} />
    ...
    const renderMagnified = (s: string) => (
        <g>
            ...
            <clipPath id={`magnifier-clip-temp${s}`}>
                <circle cx={MX} cy={MY} r={MR - 2} />
            </clipPath>
            <g clipPath={`url(#magnifier-clip-temp${s})`}>
        ...
        <div className="flex flex-col py-4 select-none">
            ...
            <div className="sm:hidden mb-3">
                <div className="flex items-center justify-between mb-1">
                    <span className="text-xs font-medium text-foreground">Temperature T (°C)</span>
                    <span className="text-sm font-mono font-bold" style={{ color: themeColor }}>{temp}°C</span>
                </div>
                <Slider
                    min={10}
                    max={50}
                ...
                <div className="flex justify-between mt-0.5">
                    <span className="text-[10px] font-mono text-muted-foreground">10° Cold</span>
                    <span className="text-[10px] font-mono text-muted-foreground">30° Optimal</span>
                    <span className="text-[10px] font-mono text-muted-foreground">50° Hot</span>
                </div>
            </div>

            {/* ── Mobile scene (beaker + cells side-by-side) ── */}
